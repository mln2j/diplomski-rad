	...
	\section{ARHITEKTURA I DIZAJN SUSTAVA}
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[node distance=2.2cm, auto]
				...
				% Nodes
				\node (browser) [device] {\textbf{\textless\textless device\textgreater\textgreater} \\ Klijentski preglednik};
				\node (sw) [component, right=of browser, xshift=1.2cm] {\textbf{\textless\textless component\textgreater\textgreater} \\ Service Worker};
				\node (cache) [database, fill=yellow!10, below=of sw, yshift=-0.5cm] {\textbf{\textless\textless storage\textgreater\textgreater} \\ IndexedDB};
				\node (nginx) [servernode, right=of sw, xshift=1.2cm] {\textbf{\textless\textless node\textgreater\textgreater} \\ Nginx Proxy};
				\node (laravel) [component, below=of nginx, yshift=-0.5cm] {\textbf{\textless\textless component\textgreater\textgreater} \\ Laravel API};
				\node (db) [database, below=of laravel, yshift=-0.5cm] {\textbf{\textless\textless database\textgreater\textgreater} \\ PostgreSQL};
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[node distance=1.5cm, auto]
				...
				% Nodes
				\node (ui) [layer, fill=blue!5] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Prezentacijski sloj (Angular UI)};
				\node (services) [layer, fill=orange!5, below=of ui] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Sloj poslovne logike (Servisi)};
				\node (repos) [layer, fill=purple!5, below=of services] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Sloj pristupa podacima (Repozitoriji)};
				\node (localdb) [infrastructure, below=of repos, xshift=-4em] {\textbf{\textless\textless infrastructure\textgreater\textgreater} \\ IndexedDB};
				\node (http) [infrastructure, below=of repos, xshift=4em] {\textbf{\textless\textless infrastructure\textgreater\textgreater} \\ HttpClient};
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[node distance=1.2cm, auto]
				...
				% Nodes
				\node (route) [layer] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Rute i Middleware};
				\node (controller) [layer, below=of route] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Prezentacijski API sloj (Kontroleri)};
				\node (service) [layer, below=of controller] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Sloj poslovne logike (Servisi)};
				\node (model) [layer, below=of service] {\textbf{\textless\textless layer\textgreater\textgreater} \\ Sloj pristupa podacima (Eloquent ORM)};
				\node (db) [database, below=of model, yshift=-0.3cm] {\textbf{\textless\textless database\textgreater\textgreater} \\ PostgreSQL / SQLite};
