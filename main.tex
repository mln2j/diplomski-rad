...
\begin{document}
	...
	Službeno odobreni tekst zadatka unutar informacijskog sustava glasi:
	
	\begin{quote}
		\textit{Web aplikacija omogućuje organizacijama i timovima strukturirano praćenje i upravljanje financijskim tokovima na razini projekata i odjela. Sustav podržava evidenciju prihoda i rashoda, kategorizaciju troškova, automatsku raspodjelu sredstava po projektima te generiranje detaljnih financijskih izvještaja i analiza. Aplikacija je implementirana kao progresivna web aplikacija koristeći Angular sučelje, Node.js backend s Express okvirom i PostgreSQL relacijsku bazu podataka. Sustav uključuje višerazinsku autentifikaciju korisnika s definiranjem uloga i prava pristupa te podršku za ponavljajuće financijske transakcije. Projekt koristi suvremene DevOps prakse kroz GitHub Actions za kontinuiranu integraciju i automatizaciju procesa implementacije.}
	\end{quote}
	
	U sklopu praktične realizacije sustava "Allocento", u dogovoru s mentorom, arhitektura pozadinskog dijela aplikacije prilagođena je kroz primjenu razvojnog okvira Laravel i pripadajućeg ekosustava, dok su inicijalno definirani funkcionalni i projektni zahtjevi u potpunosti zadržani.
