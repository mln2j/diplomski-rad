	...
	\section{ARHITEKTURA I DIZAJN SUSTAVA}
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[node distance=2.2cm, auto]
				...
				% Nodes
				\node (browser) [device] {\textit{\textless\textless uređaj\textgreater\textgreater} \\ Klijentski preglednik};
				\node (sw) [component, right=of browser, xshift=1.2cm] {\textit{\textless\textless komponenta\textgreater\textgreater} \\ Service Worker};
				\node (cache) [database, fill=yellow!10, below=of sw, yshift=-0.5cm] {\textit{\textless\textless pohrana\textgreater\textgreater} \\ IndexedDB};
				\node (nginx) [servernode, right=of sw, xshift=1.2cm] {\textit{\textless\textless čvor\textgreater\textgreater} \\ Nginx Proxy};
				\node (laravel) [component, below=of nginx, yshift=-0.5cm] {\textit{\textless\textless komponenta\textgreater\textgreater} \\ Laravel API};
				\node (db) [database, below=of laravel, yshift=-0.5cm] {\textit{\textless\textless baza podataka\textgreater\textgreater} \\ PostgreSQL};
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[node distance=1.5cm, auto]
				...
				% Nodes
				\node (ui) [layer, fill=blue!5] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Prezentacijski sloj (Angular UI)};
				\node (services) [layer, fill=orange!5, below=of ui] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Sloj poslovne logike (Servisi)};
				\node (repos) [layer, fill=purple!5, below=of services] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Sloj pristupa podacima (Repozitoriji)};
				\node (localdb) [infrastructure, below=of repos, xshift=-2.6cm] {\textit{\textless\textless infrastruktura\textgreater\textgreater} \\ IndexedDB};
				\node (http) [infrastructure, below=of repos, xshift=2.6cm] {\textit{\textless\textless infrastruktura\textgreater\textgreater} \\ HttpClient};
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[node distance=1.2cm, auto]
				...
				% Nodes
				\node (route) [layer] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Rute i Middleware};
				\node (controller) [layer, below=of route] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Prezentacijski API sloj (Kontroleri)};
				\node (service) [layer, below=of controller] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Sloj poslovne logike (Servisi)};
				\node (model) [layer, below=of service] {\textit{\textless\textless sloj\textgreater\textgreater} \\ Sloj pristupa podacima (Eloquent ORM)};
				\node (db) [database, below=of model, yshift=-0.3cm] {\textit{\textless\textless baza podataka\textgreater\textgreater} \\ PostgreSQL / SQLite};
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}[auto]
				...
				\node (user) [class] at (0, 6) {User};
				\node (member) [class] at (4.5, 4.75) {WorkspaceUser};
				\node (workspace) [class] at (0, 3.5) {Workspace};
				\node (account) [class] at (-3.5, 1.5) {Account};
				\node (category) [class] at (3.5, 1.5) {Category};
				\node (transaction) [class] at (0, -1) {Transaction};
